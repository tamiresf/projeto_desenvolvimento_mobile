        ...
        <ScrollView showsVerticalScrollIndicator={false} style={styles.scroll}>
          ...
          <SafeAreaView>
            ...
            <View>
              ...
              <Text style={{ ...styles.text, color: 'black' }}><Text style={{ fontWeight: 'bold' }}>Rayane</Text>, a menina dos sistemas! Ela é como aquela peça-chave em um jogo de quebra-cabeça: dedicada, focada e sempre pronta para decifrar novos desafios. Está há um ano imersa no mundo da análise e desenvolvimento de sistemas, absorvendo conhecimento como uma esponja. Apesar de só ter um ano de experiência, sua paixão por códigos e algoritmos é palpável. </Text>
            </View>
